...
pub const X_UNIT: f32 =  64.0; // Width in  pixels at z0 to separate
...
pub const CULL_WORLD_X_FULLSCREEN : f32 = 76.0 * 2.0; //56.0;
pub const CULL_WORLD_X_HALFSCREEN : f32 = 32.0 * 2.0;